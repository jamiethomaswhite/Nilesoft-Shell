//HEADER
    ...
    //HIDE LIST
        ...
        modify(type='drive' where=str.equals(this.name, ["copy", "cut", "new folder"]) visibility='hidden')
...
//BODY
    ...
    //TOP
        menu(title='Top' tip='A placeholder for context menu entries in the top area' type='drive' expanded='true' position='top')
        {
    ...
    //MIDDLE
        menu(title='Middle' tip='A placeholder for context menu entries in the middle area' type='drive' expanded='true' position='middle')
        {
    ...
    //BOTTOM
        menu(title='Bottom' image=\uE1E5 tip='A placeholder for context menu entries in the bottom area' type='drive' expanded='true' position='bottom')
        {
