...
//BODY
    ...
    //TOP
        menu(title='Top' tip='A placeholder for context menu entries in the top area' type='namespace' expanded='true' position='top')
        {
    ...
    //MIDDLE
        menu(title='Middle' tip='A placeholder for context menu entries in the middle area' type='namespace' expanded='true' position='middle')
        {
    ...
    //BOTTOM
        menu(title='Bottom' image=\uE1E5 tip='A placeholder for context menu entries in the bottom area' type='namespace' expanded='true' position='bottom')
        {
